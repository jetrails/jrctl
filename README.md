...
![](https://img.shields.io/badge/Version-1.0.2-green.svg?style=for-the-badge&labelColor=89BA40&color=282F38)
...
```shell
$ curl -Ls https://github.com/jetrails/jrctl/releases/download/1.0.2/jrctl_linux_amd64 -o jrctl
$ chmod +x jrctl
